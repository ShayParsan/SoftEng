...
public class DbInitializer {
    ...
    public void init() {
        ...
        // === Buildings ===
        final var mainBuilding = buildingRepository.save(new Building("Main Building"));
        final var techBuilding = buildingRepository.save(new Building("Technology Center"));

        // === Rooms ===
        final var room101 = roomRepository.save(new Room("Room 101", mainBuilding));
        final var room202 = roomRepository.save(new Room("Room 202", techBuilding));
        final var room303 = roomRepository.save(new Room("Room 303", mainBuilding));
