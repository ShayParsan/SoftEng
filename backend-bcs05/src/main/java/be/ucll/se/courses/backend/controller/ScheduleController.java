...
import be.ucll.se.courses.backend.controller.dto.AssignRoomInput;
...
public class ScheduleController {
    ...
    @PostMapping("/{scheduleId}/assign-room")
    public Schedule assignRoom(@PathVariable Long scheduleId, @RequestBody AssignRoomInput input) {
        return scheduleService.assignRoom(scheduleId, input.roomId());
    }
}
